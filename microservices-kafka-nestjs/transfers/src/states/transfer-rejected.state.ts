...
@Injectable()
export class TransferRejectedState implements ITransferState {
  private readonly logger = new Logger(TransferRejectedState.name);
  constructor(
  ...
  async rejected(transferDTO: TransferDTO): Promise<TransferDTO> {
